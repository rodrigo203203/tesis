...
Otro apartado importante es tener en cuenta el tipo de cámara que se usara, ya que dependiendo de la calidad del video la exigencia de la aplicación será mayor, es decir, que si se trabaja con videos en 720p (1280x720 pixeles) consumirá menos recursos de la computadora que al trabajar con un video en 1080p (1920x1080 pixeles), porque la imagen es más pequeño y eso genera menos información al procesarlo.
