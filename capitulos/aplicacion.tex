...
Antes de poder ejecutar debidamente la aplicación se tiene que configurar los parámetros principales, el cual dependerá de los requerimientos del supermercado. En este caso, este supermercado considera que el tiempo promedio máximo es de 5 segundos y el tiempo máximo de una persona sin cruzar el límite es de 10 segundos.  Otro factor importante es la posición de la cámara, que en este caso se encuentra enfocando la parte lateral de la fila, lo cual llega a modificar la posición del límite de detección. Estas modificaciones se observan en el Código \ref{70}. 
\clearpage
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.33]{imagenes/caso4.png}
