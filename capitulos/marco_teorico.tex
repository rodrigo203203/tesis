...
Posterior mente, se presentó los fundamentos teóricos que estén relacionados con las redes neuronales artificiales. Abarcando los temas de como surgió, comparación de una neurona con una artificial y la estructura que lo compone. De esta manera se explicará las diferentes maneras que se puede crear un sistema de redes neuronales. Principalmente enfocándose en la estructura de la red neuronal YOLO, la cual es la que se utilizara para este proyecto. Por otra parte, se explicó las ventajas de usar herramientas que este alojado en la nube, sobre todo en los casos que no se puede contar con un buen equipo.  
