...
Desarrollar una aplicación utilizando redes neuronales convulucionales para detectar personas y así poder calcular el tiempo de espera promedio de los clientes en un sistema de atención de fila única en un supermercado.
...
Una fila muy larga en la atención de las cajas afecta tanto al cliente (más tiempo de espera) como al supermercado (clientes que se retiran sin terminar su compra). Reducir el tiempo de  espera de un comprador habilitando más cajas para la atención, podría mejorar la experiencia de compra y con ello aumentar las probabilidades de retorno del cliente al local. Por tanto, este proyecto se lleva a cabo para ayudar a determinar cuántas cajas tienen que estar abiertas en un sistema de fila única. 
\\  
