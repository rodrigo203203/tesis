...
\begin{equation}
\label{eq:vpvfss}
	\text{Tasa de verdaderos positivos (TVP)} =\frac{VP}{VP + VN} 
\end{equation}

\begin{center}
\begin{list}{}{}
	\item \textbf{VP} = Verdadero positivo.
	\item \textbf{VN} = Falso positivo.
\end{list}
\end{center}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.7]{imagenes/roc23.png}
...
Aplicando la ecuación anterior se obtuvo un valor de 0.58, lo que indica que el rendimiento de la red no es bueno, para que una red entrenada tenga un rendimiento óptimo deberá tener un valor superior a 0.7. 

Este valor de 0.58 podría mejorar realizando entrenamientos más largos a la red neuronal, tanto en la cantidad de iteraciones que tendría que dar como la cantidad de imágenes con la cual entrena, estas imágenes en su preferencia deberán ser más variadas.  
