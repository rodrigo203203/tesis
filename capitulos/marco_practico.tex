...
Todas las imágenes obtenidas fueron clasificadas mediante la explicación anterior, con lo cual se obtuvo en total de 219 VP, 45 FP y 39 FN. En la Tabla \ref{tab:FP}, se observa cómo se clasifico las detecciones y los tiempos en la cual se obtuvo la imagen para ser analizados. 

\begin{table}[h]
\begin{center}
	\caption{Datos obtenidos mediante el análisis realizado de las detecciones de la red neuronal.}
\begin{tabular}{| c | c | c | c |}
\hline \textbf{Tiempo} & \textbf{Verdadero Positivo} & \textbf{Falso Positivo} & \textbf{Falso Negativo} \\ \hline
00:13  & 6  & 2  & 2  \\
00:21  & 0  & 0  & 1  \\
00:28  & 8  & 0  & 2  \\
00:38  & 5  & 0  & 3  \\
...
\begin{equation}
\label{eq:vpvf}
	Precision=\frac{VP}{VP + VF} 
\end{equation}


Utilizando la anterior ecuación obtenemos una precisión del 80\%, la cual es bastante alto y demuestra una confiabilidad de los resultados que podrá obtener la red neuronal. Pero para poder demostrar el rendimiento se tiene utilizar la gráfica ROC, para poder obtener esta gráfica será necesario utilizar los siguientes parámetros: tasa de verdaderos positivos y tasa de falsos positivos. Pero para poder obtener esos datos primeramente los datos obtenidos sen la tabla se irán sumando el dato actual con el anterior. Realizando este procedimiento se obtiene la siguiente Tabla \ref{tab:tiempo}.

\clearpage

\begin{table}[h]
\begin{center}
	\caption{Sumatoria Progresiva de los datos anteriores.}
\begin{tabular}{| c | c | c |}
\hline \textbf{Verdadero Positivo} & \textbf{Falso Positivo} & \textbf{Falso Negativo} \\ \hline
0 & 0  & 2 \\
6 & 2  & 0 \\
6 & 2  & 0 \\
14 & 2  & 0\\
...
Utilizando estos se podrá calcular la tasa de VP y FP con lo que se podrá obtener la gráfica de rendimiento de la red neuronal, para ellos se aplicará la siguiente Ecuación \ref{eq:tvpvf}. 
...
Aplicando la anterior ecuación se obtuvo la siguiente Tabla \ref{tab:TVFTFV}, la cual permite obtener la gráfica ROC. 

\begin{table}[h]
\centering
\caption{Tasa de Verdaderos Positivos y Falsos Positivos}
\begin{tabular}{| c | c |} 
\hline
\textbf{Tasa de VP} & \textbf{Tasa de FP}  \\ 
\hline
1          & 1           \\ 
\hline
1          & 1           \\ 
\hline
0.97260274 & 0.95555556  \\ 
\hline
0.97260274 & 0.95555556  \\ 
\hline
0.93607306 & 0.95555556  \\ 
\hline
0.91324201 & 0.95555556  \\
\hline
\end{tabular}
\label{tab:TVFTFV}
\sources{Elaboración propia.}
...
Con estos datos y aplicando el grafico de línea se obtiene el rendimiento que posee la red neuronal entrenada. Esto se podrá observar en la Figura \ref{fig:FROC}, Los datos de las tablas anteriores no está completas ya que se analizaron varios objetos, por eso mismo las tablas completas se podrá observar en el apartado de los anexos del documento. 

\clearpage

\begin{figure}[h]
	\centering
	\includegraphics[scale=0.7]{imagenes/curvaROC.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.6]{imagenes/imagen2.png}
