...
\contentsline {lstlisting}{\numberline {3.1}Comando que realiza una prueba a la red neuronal para obtener la precisión media.}{55}{lstlisting.3.1}%
...
\contentsline {lstlisting}{\numberline {4.4}Funcción para calcular el objeto más cercano al límite.}{75}{lstlisting.4.4}%
\contentsline {lstlisting}{\numberline {4.5}Configuración de los parámetros para el caso de estudio.}{77}{lstlisting.4.5}%
\contentsline {lstlisting}{\numberline {A.1}Reporte de precisión media.}{85}{lstlisting.Alph1.1}%
